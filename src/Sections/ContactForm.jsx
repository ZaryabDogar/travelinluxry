		...
		<section className="lg:px-12 sm:px-6 px-3 sm:mb-16 flex  " id="contact">
			<div className="flex flex-col lg:flex-row justify-center items-center w-full bg-[#CC405D0F] rounded-[32px] ">
				...
				<div className="lg:w-1/2 flex    sm:px-10 px-5  sm:py-16 py-10">
					<div className="font-Lora text-white lg:text-start text-center">
						<p className=" lg:block hidden   mb-14 font-[500] text-[42px] leading-[28px]   ">
							<span className="border-b-[3px] border-[#CC405D] pb-2.5 ">
								Lets Get
							</span>{' '}
							in Touch!
						</p>
						<p className="lg:hidden block    mb-14 font-[500] sm:text-[42px] text-[25px] leading-[28px]   ">
							Let
							<span className="border-b-[3px] border-[#CC405D] pb-2.5 ">
								s Get in To
							</span>
						...
						<p className="sm:text-[16px]  text-[14.5px] font-[400] leading-[28px]   mb-8">
							PLEASE NOTE THAT THIS FORM IS MONITORED MON-FRI FROM 9AM-5PM. IF
							YOU REQUIRE 24/7 ASSISTANCE PLEASE EMAIL RESERVATION@CULLITONS.COM
						</p>
						<p className="sm:text-[20px]  text-[16px] font-[700] leading-[25.6px]   mb-4">
							ADDRESS
						</p>
						<p className="sm:text-[16px]  text-[14.5px] font-[400] leading-[12.6px]   mb-4">
							511 McNicoll Ave, Suite 201
						</p>
						<p className="sm:text-[16px]  text-[14.5px] font-[400] leading-[12.6px]   mb-8">
				...
				<div className="lg:w-1/2 pt-10 p-6 flex w-full justify-center">
					<form
						ref={form}
						className="font-inter w-full flex flex-col justify-center lg:items-start items-center"
						onSubmit={sendEmail}
					>
						{/* Name Fields */}
						...
						<div className="xl:w-[485.38px] w-full max-w-[480px] xl:mb-6 mb-4   ">
							<label
								htmlFor="name"
								className="block md:text-[17.4px] text-[16px] leading-[20.1px] xl:mb-6 mb-4 text-white   "
							>
								Full Name*:
							</label>
							<input
						...
						{/* Email and  */}
						<div
							className="xl:w-[485.38px]    w-full max-w-[480px] xl:mb-6 mb-4  
             "
						>
							<label
								htmlFor="email"
						...
						<div
							className=" xl:mb-6  xl:w-[485.38px]  w-full max-w-[480px]   mb-4
             "
						>
							<label
								htmlFor="phone"
						...
						<div className="flex lg:justify-between sm:items-start sm:justify-evenly  w-full sm:flex-row flex-col items-center space-y-6 sm:space-y-0">
							...
							>
								{' '}
								<button
									className={`font-[500] text-major  sm:px-6 sm:py-4 sm:rounded-[10.87px] px-4 py-4 rounded-full text-[#000000] bg-[#CC405D] ${
										showButton ? 'fixed bottom-5 sm:right-6 right-2' : 'hidden'
									} `}
								>
