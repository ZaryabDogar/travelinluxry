...
import int1 from '../assets/6pass/interior1.png';
import int2 from '../assets/6pass/interior2.png';
import int3 from '../assets/6pass/6pass.png';
				...
				<div>
					<div className="2xl:mb-6 mb-3">
						...
						<p className="xl:text-[18px] sm:text-[16px] text-[14px]">
							$115.00 per hour to the nearest half hour (min. 2hour)
						</p>
					</div>
					...
					<div className="">
						<div className="flex items-center space-x-5 font-bold">
							...
							<p className="xl:text-[20px] sm:text-[18px] text-[16px]">
								Airport Transfers starting at $115
							</p>
						</div>
						<p className="xl:text-[18px] sm:text-[16px] text-[14px]">
