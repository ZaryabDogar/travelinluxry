...
import pass from '../assets/15pass.png';
import int1 from '../assets/14pass/interior1.png';
import int2 from '../assets/14pass/interior2.png';
import int3 from '../assets/14pass/14pass.png';
		...
		<div className="w-full">
			...
			<div className="2xl:pt-12 pt-3 w-full font-raleway sm:px-6 flex relative md:flex-row md:justify-between flex-col md:items-start items-center">
				<div>
					<div className="2xl:mb-6 mb-3">
						...
						<p className="xl:text-[18px] sm:text-[16px] text-[14px]">
							$175.00 per hour to the nearest half hour (min. 2hour)
						</p>
					</div>
				...
				<div className=" 2xl:w-full flex justify-end items-end">
					<img
						src={pass}
						className="2xl:w-[654px] xl:w-[500px] lg:w-[400px] md:w-[550px] w-[350px] "
						alt=""
					/>
				</div>
			</div>
