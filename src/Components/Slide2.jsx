...
const Slide2 = () => {
    ...
    useEffect(() => {
      ...
      const backgroundStyle = {
        backgroundImage: `linear-gradient(to top,rgba(0,0,0,1), transparent), url(${img})`,
    ...
    >
      <h1 className="md:text-[50px] sm:text-4xl text-2xl font-[500] leading-[28px]  mb-5">WIDE RANGE OF VEHICLES</h1>
      <p className="sm:text-[16px]  text-sm font-[400] leading-[28px] max-w-lg">Cullitons offers a wide selection of vehicles ranging from 4 passenger sedans to 55 passenger buses, and everything in between. ​We are sure to have what you are looking for.</p>
